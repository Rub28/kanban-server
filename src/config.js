...
module.exports = {
    ...
    mysql:{
        host: process.env.MYSQL_HOST ||  '127.0.0.1',  // '82.29.198.42',   // '127.0.0.1', // , solo por que ocupa de forma local, pero en produccion se conecta a la base de datos remota
