...
async function todos(req,res, next){
   try {
      console.log(" -->  Clientes funcion todos ",req.query);   a
...
async function todosClientes (req,res, next){
   try {
      console.log(" -->  Clientes funcion todos ",req.query);   a
      const items = await controlador.todosClientes(req.params.id)
      respuestas.success(req, res, items, 200) 
   } catch (error) {
      next(error)
   }  
...
async function uno (req,res, next){
   try {
      console.log(" -->  Clientes funcion uno  en Administracion: ",req.body);    
